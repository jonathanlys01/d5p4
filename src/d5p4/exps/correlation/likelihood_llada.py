...
from d5p4.utils import seed_all, tqdm
...
def get_llada_log_likelihood(model, prompt, answer, mc_num=128, batch_size=16, mask_id=126336) -> float:
    """
...
def compute_internal_scores(model, prompt, answer, mc_num=64, batch_size=16, mask_id=126336) -> tuple[float, float]:
    """
